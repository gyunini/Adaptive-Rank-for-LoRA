...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=float,
        default=1e-4,
        help="plateau 판단: 최소 개선량",
    )
    parser.add_argument(
        "--plateau_patience",
        type=int,
        default=3,
        help="plateau 판단: 연속 bad epoch 수",
    )
    parser.add_argument(
        "--rank_step",
        type=int,
        default=2,
        help="rank 증가 시 한 번에 늘릴 크기",
    )
...
def main():
    ...
    print(f"Initial ranks: {[m.r_eff for m in adaptive_modules]}")
